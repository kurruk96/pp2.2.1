...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      carService.add(new Car("car1", 1234));
      carService.add(new Car("car2", 3566));
      carService.add(new Car("car3", 2345));
      carService.add(new Car("car4", 4567));
      ...
      System.out.println(userService.getUserIfCar("car3", 2345));
